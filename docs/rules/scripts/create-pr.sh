...
# Usage: ./scripts/create-pr.sh <feature-name> <task-id> "user request"
...
This PR was created following the DeepWork feature branch workflow.
All changes were made in the feature branch as per workspace rules.

---
Following template @templates/T006
EOF
)
